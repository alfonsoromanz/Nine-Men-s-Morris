...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ControlButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 5)
    ...
    "ControlButton\0clicked\0\0scale\0"
};
...
const QMetaObject ControlButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ControlButton.data,
      qt_meta_data_ControlButton,  qt_static_metacall, 0, 0}
};
...
void *ControlButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< ControlButton*>(this));
